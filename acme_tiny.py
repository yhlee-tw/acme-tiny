...
def get_crt(account_key, csr, acme_dir, log=LOGGER, CA=DEFAULT_CA, disable_check=False, directory_url=DEFAULT_DIRECTORY_URL, contact=None, check_port=None, alternate_chain=False, challenge_type="http", challenge_script=None):
...
def main(argv=None):
    ...
    signed_crt = get_crt(args.account_key, args.csr, args.acme_dir, log=LOGGER, CA=args.ca, disable_check=args.disable_check, directory_url=args.directory_url, contact=args.contact, check_port=args.check_port, alternate_chain=args.alternate_chain, challenge_type=args.challenge_type, challenge_script=args.challenge_script)
